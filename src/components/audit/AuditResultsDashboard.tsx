...
<div class="page">
  ...
  <div class="grid2" style="margin-bottom:16px;">
    ...
    <div class="card">
      ...
      <table>
        <thead><tr><th>Name</th><th style="text-align:right;">Avg Rank</th></tr></thead>
        <tbody>
          ${competitors.slice(0,5).map(c => `<tr>
            ...
            <td style="text-align:right;font-size:14px;font-weight:900;color:#1e293b;">${(c as any).avgRank > 0 ? (c as any).avgRank : c.rating > 0 ? `${c.rating} ★` : '—'}</td>
          </tr>`).join('')}
        </tbody>
